...
function OverviewSection({ overview }) {
  return (
    ...
    <div className="rounded-2xl border border-brand-border bg-brand-white p-6 shadow-sm">
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2">
      {items.map((item) => (
        <article
          key={item.title}
          className="flex h-full flex-col rounded-2xl border border-brand-border bg-brand-white p-6 shadow-sm"
        >
