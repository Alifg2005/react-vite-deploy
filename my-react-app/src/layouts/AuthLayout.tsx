...
import logo from "../images/capsuleDark.png";
...
export default function AuthLayout({ backTo, panelTitle, panelSubtitle, heading, subheading, children }: AuthLayoutProps) {
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-10rem)] w-full max-w-6xl items-center justify-center py-8">
        <div className="grid w-full overflow-hidden rounded-[35px] bg-brand-white/80 backdrop-blur-xl shadow-[0_25px_60px_rgba(0,0,0,0.15)] border border-brand-border lg:grid-cols-2">
          ...
          <div
            ...
            style={{
              backgroundImage: `linear-gradient(rgba(7,59,76,0.72), rgba(7,59,76,0.55)), url(${authPhoto})`,
            }}
          >
            ...
            <img src={logo} alt="Capsule Tahawul" className="w-72 drop-shadow-2xl" />
